...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({ from: `LABS <${process.env.FROM_EMAIL || 'hello@longevityandbiohacking.org'}>`, to: process.env.ADMIN_EMAIL || 'zack@joineta.org', replyTo: email, subject: notification.subject, html: notification.html })
